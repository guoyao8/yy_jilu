...
export default function EditBabyPage() {
  ...
  const { currentUser, babies, updateBaby, hasHydrated } = useAppStore()
  ...
  }, [currentUser, hasHydrated, baby, router])

  if (!currentUser || currentUser.role !== "admin" || !baby) {
    return null
  }
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-bold ml-2">编辑宝宝信息</h1>
      </div>
